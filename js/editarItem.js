const editarItem = (elemento) => {
    ...
    if(novoItem !== null && novoItem.trim() !== "") {
        ...
        textoData.innerText = `${new Date().toLocaleDateString("pt-BR", { weekday: "long" })} (${new Date().toLocaleDateString()}) às ${new Date().toLocaleTimeString("pt-BR", { hour: "numeric", minute: "numeric" })}`;
    }
}
